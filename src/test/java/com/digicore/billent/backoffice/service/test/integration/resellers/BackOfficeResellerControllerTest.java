...
class BackOfficeResellerControllerTest {
    ...
    private static PaginatedResponseDTO<BackOfficeResellerProfileDTO> getPaginatedResponseDTO(MvcResult result) throws UnsupportedEncodingException, JsonProcessingException {
        ApiResponseJson<PaginatedResponseDTO<BackOfficeResellerProfileDTO>> response =
                ClientUtil.getGsonMapper()
                        .fromJson(result.getResponse().getContentAsString().trim(), new TypeToken<ApiResponseJson<PaginatedResponseDTO<BackOfficeResellerProfileDTO>>>() {}.getType());
    ...
    void testGetAllResellers() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(get(RESELLERS_API_V1 + "get-all")
        ...
        PaginatedResponseDTO<BackOfficeResellerProfileDTO> paginatedResponseDTO = getPaginatedResponseDTO(mvcResult);
