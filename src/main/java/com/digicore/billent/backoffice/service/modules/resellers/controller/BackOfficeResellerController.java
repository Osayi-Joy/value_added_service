...
public class BackOfficeResellerController {
  ...
  @PatchMapping("disable-{resellerId}")
  @PreAuthorize("hasAuthority('disable-reseller')")
  @Operation(
          summary = RESELLER_CONTROLLER_DISABLE_RESELLER_TITLE,
          description = RESELLER_CONTROLLER_DISABLE_RESELLER_DESCRIPTION)
  public ResponseEntity<Object> enableReseller(@PathVariable String resellerId) {
    backOfficeResellerProxyService.disableReseller(resellerId);
    return ControllerResponse.buildSuccessResponse(null,"Reseller edisabled successfully");
  }
}
