...
public class SwaggerDocUtil {
  ...
  public static final String AUTHENTICATION_CONTROLLER_VERIFY_EMAIL_OTP_DESCRIPTION = "This API verifies a user's email, it sends an otp to the user's phoneNumber after successfully validating the email";

  public static final String AUTHENTICATION_CONTROLLER_VERIFY_SMS_OTP_TITLE = "Verify a user's phoneNumber";

  public static final String AUTHENTICATION_CONTROLLER_VERIFY_SMS_OTP_DESCRIPTION="This API verifies a user's phoneNumber for password reset";

  public static final String AUTHENTICATION_CONTROLLER_UPDATE_PASSWORD_TITLE= "Reset user password";

  public static final String AUTHENTICATION_CONTROLLER_UPDATE_PASSWORD_DESCRIPTION= "This API resets a user's existing password to a new password provided by the user, the otp required is the resetKey that came from the response after validating the phone number";
